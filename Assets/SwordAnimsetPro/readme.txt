Sword Animset Pro 1.0
--------------------------

This package contains a set of over 170 motion captured animations for characters armed with one handed sword. It also contains 2 sword fighting game templates with "drag and drop" Player and Enemies controllers, made in PlayMaker visual scripting plugin in Unity3d.
...
- equip/unequip sword
- victory animations
- NPC guard slow walks and idling
- and more
